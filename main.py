...
def segregate(dir):
    ...
    for i in LIST:
        var = tk.StringVar()
        var.set("1")
        checkbox = tk.Checkbutton(frame2, text=i, variable=var, font=(
            "Helvetica", 10), padx=5, pady=20, bg="white")
        checkdict[i] = var
...
if __name__ == "__main__":
    ...
    seg_btn = tk.Button(window, image=image1, borderwidth=0,
                        command=printme, bg="white")
    seg_btn.pack()
